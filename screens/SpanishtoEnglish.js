...
export default class EngtoSp extends Component{
  ...
  getWord=(word)=>{
    ...
    then ((data)=>{
      ...
      .then((response)=>{
        ...
        console.log(word)
        var translation = response.[0].shortdef
  ...
  render(){
    return (
      ...
      centerComponent={{text:'Spanish to English Translation', style:{color:'#000', fontSize: RFValue(11), fontWeight: "bold"}}}
      />
              ...
              (
                ...
                <View style={{justifyContent:'center', marginLeft:10 }}>
                  ...
                  <View style={{flexDirection:'row',flexWrap: 'wrap'}}>
                    <Text>
                      Translation : {this.state.translation[0]}
                    </Text>
